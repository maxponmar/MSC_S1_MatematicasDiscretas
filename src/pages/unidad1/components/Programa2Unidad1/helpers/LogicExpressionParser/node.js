  ...
  constructor(
    ...
    if (operator == null && left == null && right == null && nodeObj == null) {
      throw new MissingValue(
        "Required variable(s) for LogicNode. Must use either operator, left, and right or nodeObj."
      );
    }
    ...
    // Check if nodeObj exists
      ...
      if (!("operator" in nodeObj)) {
        throw new MissingValue(
          'Required key for LogicNode. Must have "operator" in nodeObj.'
        );
      } else {
      ...
      if (!("left" in nodeObj)) {
        throw new MissingValue(
          'Required key for LogicNode. Must have "left" in nodeObj.'
        );
      } else {
      ...
      if (!("right" in nodeObj)) {
        throw new MissingValue(
          'Required key for LogicNode. Must have "right" in nodeObj.'
        );
      } else {
